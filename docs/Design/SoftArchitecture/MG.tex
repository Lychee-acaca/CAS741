...
\item[\refstepcounter{acnum} \actheacnum \label{acFilter}:] The types of digital
filters.
\end{description}
...
they are referenced by all other modules except themselves.  Each level of the
hierarchy offers a testable and usable subset of the system, and modules in the
higher level of the hierarchy are essentially simpler because they use modules
